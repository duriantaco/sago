...
def test_estimate_tokens_positive(estimator: CostEstimator, sample_tasks: list[Task]) -> None:
    estimate = estimator.estimate_workflow(sample_tasks)
...
def test_estimate_cost_positive(estimator: CostEstimator, sample_tasks: list[Task]) -> None:
    estimate = estimator.estimate_workflow(sample_tasks)
    assert estimate.estimated_cost_usd > 0


def test_estimate_duration_is_range(estimator: CostEstimator, sample_tasks: list[Task]) -> None:
    estimate = estimator.estimate_workflow(sample_tasks)
...
def test_plan_generation_adds_cost(estimator: CostEstimator, sample_tasks: list[Task]) -> None:
...
def test_verification_adds_time(estimator: CostEstimator, sample_tasks: list[Task]) -> None:
...
def test_breakdown_by_phase(estimator: CostEstimator, sample_tasks: list[Task]) -> None:
    estimate = estimator.estimate_workflow(sample_tasks)
...
def test_phase_costs_sum_to_total(estimator: CostEstimator, sample_tasks: list[Task]) -> None:
...
def test_cost_estimate_str(estimator: CostEstimator, sample_tasks: list[Task]) -> None:
    estimate = estimator.estimate_workflow(sample_tasks)
    s = str(estimate)
